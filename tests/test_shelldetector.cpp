...
static void testShellDetection() {
    ShellDetector::Shell shell = ShellDetector::detectShell();
    std::cout << "  Detected shell: " << ShellDetector::getShellName(shell) << std::endl;
    assert(shell != ShellDetector::Shell::UNKNOWN || true);
}
...
static void testConfigFilePath() {
    assert(ShellDetector::getConfigFilePath(ShellDetector::Shell::BASH).find(".bashrc") != std::string::npos);
    assert(ShellDetector::getConfigFilePath(ShellDetector::Shell::ZSH).find(".zshrc") != std::string::npos);
    assert(ShellDetector::getConfigFilePath(ShellDetector::Shell::FISH).find(".config/fish") != std::string::npos);
}
